...
def create_default_cards(filepath):
    ...
    cards = [
        ...
        {"name": "进攻型桶滚", "type": "type_support", "role": "role_torpedo", "attack": 4, "defense": 2,
         "skill_id": "atk_prev_bomb", "skill_levels": [3, 6, 9], "skill_type": "fixed",
        ...
        {"name": "信仰飞跃", "type": "type_defense", "role": "role_fighter", "attack": 5, "defense": 5,
         "skill_id": "def_adjacent", "skill_levels": [150, 175, 200], "skill_type": "percent",
         "skill_desc": "desc_leap_of_faith", "fleet_count": 2,
         "trans_key": "skill_leap_of_faith"},
        {"name": "四指队形", "type": "type_attack", "role": "role_torpedo", "attack": 4, "defense": 3,
         "skill_id": "atk_fixed_after_def5", "skill_levels": [4, 6, 8], "skill_type": "fixed",
        ...
        {"name": "萨奇剪", "type": "type_defense", "role": "role_fighter", "attack": 5, "defense": 5,
